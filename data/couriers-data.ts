export const couriersData = [
  ...
  {
    label: "FedEx", value: "fedex", services: [
  ...
  {
    label: "Royal Mail", value: "royalmail", services: [
      ...
      { label: "Special Delivery 9:00 AM", value: 'royalmail-special-delivery-9.00-am' },
      { label: "Special Delivery 1:00 PM", value: 'royalmail-special-delivery-1.00-pm' },
    ]
  },
  {
    label: "DHL", value: "dhl", services: [
      { label: "Global Priority", value: 'dhl-global-priority' }
    ]
  },
  {
    label: "Samos", value: "samos", services: [
      { label: "EU Road", value: 'samos-eu-road' }
    ]
  },
  {
    label: "Collect", value: "collect", services: [
