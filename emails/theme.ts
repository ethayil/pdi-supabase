...
// ─── Barebones Theme Config ──────────────────────────────────────────────
const barebonesColors = {
  bg: "#FFFFFF",
  "bg-2": "#F3F4F6",
  fg: "#14171E",
  "fg-2": "#43454B",
...
const barebonesFontScale = {
  ...
  15: { fontSize: "15px", fontWeight: "450", lineHeight: "1.5" },
  16: {
    fontSize: "16px",
    fontWeight: "420",
...
export const barebonesBoxedTailwindConfig: TailwindConfig = {
  plugins: [
    plugin(({ addUtilities, addVariant }) => {
      ...
      for (const [step, token] of Object.entries(barebonesFontScale)) {
